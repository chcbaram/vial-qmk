...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT( 
      ...
      _______, KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(1),
      _______, KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,                             KC_SPC,                    KC_RALT, KC_RGUI, MO(1),   KC_RCTL
  ),
};
